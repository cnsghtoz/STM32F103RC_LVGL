...
#define Example 1
    ...
    //     static lv_color_t buf3_2[LV_HOR_RES_MAX * LV_VER_RES_MAX];                      /*An other screen sized
    //     buffer*/ lv_disp_buf_init(&disp_buf_3, buf3_1, buf3_2, LV_HOR_RES_MAX * LV_VER_RES_MAX); /*Initialize the
    //     display buffer*/
    // #endif
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    ...
    //         /*put_px(x, y, *color_p)*/
    //         int c = lv_color_to16(*color_p);
    //         Lcd_DrawPoint(x, y, c);
    //         //     printf("x = %d, y = %d, color code = %d\t", x, y, c);
    //         color_p++;
    //     }
    // }
